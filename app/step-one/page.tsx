    ...
    <div className="pl-10 xl:pt-6 pt-2 h-full w-5/6 grid  content-start relative ">
      ...
      >
        ...
        <div className="grid justify-end ">
          <button
            type="submit"
            className="md:absolute bottom-2 right-0 text-white bg-MarineBlue focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-fit  px-5 py-2.5 text-center self-end"
          >
            Next Step
          </button>
        </div>
